...
class AuthorizationMatrixTest {
    ...
    @CsvSource({
            ...
            "PUT,    /api/posts/1/reaction",
            "DELETE, /api/posts/1/reaction",
            "PUT,    /api/comments/1/reaction",
            "DELETE, /api/comments/1/reaction",
