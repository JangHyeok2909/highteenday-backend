package com.example.highteenday_backend.doain.users;


import com.example.highteenday_backend.doain.base.BaseEntity;
import com.example.highteenday_backend.doain.schools.School;
...
public class User extends BaseEntity {
    ...
    @Column(name = "USR_proifile_image_url", columnDefinition = "TEXT")
